...
description: The learner-facing side of the Liverpool Dental Learning Hub.
sidebar:
  order: 2
---
...
![Liverpool Dental Learning Hub home page](../../../assets/screenshots/lms-home.png)
...
![Course catalogue at /courses](../../../assets/screenshots/lms-catalog.png)

*The catalogue at `/courses`. Each course is published from Studio.*

![Learner dashboard showing enrolled courses](../../../assets/screenshots/learner-dashboard.png)
